...
extension TVApp {
    ...
    //New APPs
    public static func youtubeTv() -> TVApp {
        TVApp(id: "3201901017640", name: "YouTube TV")
    }

    public static func youtubeMusic() -> TVApp {
        TVApp(id: "3201901017641", name: "YouTube Music")
    }

    public static func youtubeKids() -> TVApp {
        TVApp(id: "3201901017642", name: "YouTube Kids")
    }

    public static func disnep() -> TVApp {
        TVApp(id: "3201901017643", name: "Disney+")
    }

    public static func tubi() -> TVApp {
        TVApp(id: "3201901017644", name: "Tubi")
    }

    public static func peacock() -> TVApp {
        TVApp(id: "3201901017645", name: "Peacock")
    }

    public static func googlePlay() -> TVApp {
        TVApp(id: "3201901017646", name: "Google Play Movies & TV")
    }

    public static func hbo() -> TVApp {
        TVApp(id: "3201901017647", name: "HBO Max")
    }

    public static func haystackNews() -> TVApp {
        TVApp(id: "3201901017648", name: "Haystack News")
    }
}
