...
public enum Key: UInt {
    ...
    // [0x52, 0x04, 0x08, code, 0x10, 0x03]
      ...
      case KEYCODE_HOME                             = 3     //Home
      case KEYCODE_BACK                             = 4     //Back
      case KEYCODE_CALL                             = 5
      ...
      case KEYCODE_DPAD_UP                          = 19    //Dpad
      case KEYCODE_DPAD_DOWN                        = 20    //Down
      case KEYCODE_DPAD_LEFT                        = 21    //Left
      case KEYCODE_DPAD_RIGHT                       = 22    //Right
      case KEYCODE_DPAD_CENTER                      = 23    //Okay
      case KEYCODE_VOLUME_UP                        = 24    //Volume Up
      case KEYCODE_VOLUME_DOWN                      = 25    //Volume Down
      case KEYCODE_POWER                            = 26    //Power
      ...
      case KEYCODE_SEARCH                           = 84    //Search
      case KEYCODE_MEDIA_PLAY_PAUSE                 = 85    //Media Button
      case KEYCODE_MEDIA_STOP                       = 86    //Stop
      case KEYCODE_MEDIA_NEXT                       = 87    //Next
      case KEYCODE_MEDIA_PREVIOUS                   = 88    //Previous
      case KEYCODE_MEDIA_REWIND                     = 89    //Rewind
      case KEYCODE_MEDIA_FAST_FORWARD               = 90    //Fast Forward
      case KEYCODE_MUTE                             = 91    //Mute
      ...
      case KEYCODE_ALL_APPS                         = 284       //all apps
