 ...
 * session's volume. The default value is @c NO meaning that the physical volume buttons will
 * not control the receiver device's volume when a Cast session is active.
 */
