 ...
 * The content ID for this stream.
 *
 * Note that the use of contentURL and entity can be more flexible.  New applications should
 * consider using those instead.
 *
 * Do not combine with entity.
 */
 ...
 * attributes initialized to default values.
 *
 * Note that initWithContentURL: or initWithEntity: can be more flexible.  New applications
 * should consider using those instead.
 */
- (instancetype)initWithContentID:(NSString *)contentID;
 ...
 * attributes initialized to default values.
 *
 * @deprecated contentID should not be combined with entity.  Use initWithContentURL: or
 * initWithEntity: instead.
 */
- (instancetype)initWithContentID:(NSString *)contentID
                           entity:(NSString *)entity
    GCK_DEPRECATED(
        "Do not combine contentID with entity. Use initWithContentURL: or initWithEntity:");
